// ==========================================
// BACKUPS PANELİ: Güvenli Yedekler, Excel Arşivi & Taslak Kurtarma
// ==========================================
...
function initDraftTracking() {
  ...
  // F5 veya Sayfadan Ayrılma Öncesi Tarayıcı Onay Uyarısı
  window.addEventListener('beforeunload', (e) => {
    if (isFormDirty) {
      const msg = "Kaydedilmemiş değişiklikleriniz var, yine de çıkmak istediğinizden emin misiniz?";
      e.preventDefault();
      e.returnValue = msg;
      return msg;
    }
...
function markFormClean() {
  ...
  try {
    ...
    fetch(`${API_BASE}/api/cache/draft`, { method: 'DELETE' }).catch(() => {});
  } catch(e) {}
}


function checkUnsavedDraftOnStartup() {
  // Geri gelindiğinde kullanıcıyı rahatsız etmemesi için açılış modalı kaldırıldı
  return;
}
