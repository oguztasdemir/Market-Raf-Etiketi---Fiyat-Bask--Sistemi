...
function renderCatalogTable(reset = true) {
  ...
  newChunk.forEach(p => {
    ...
    tr.innerHTML = `
      ...
      <td style="text-align: right; color: #94a3b8; font-weight: 600; font-family: monospace;">${buyingPriceDisp}</td>
      <td style="text-align: right;"><span class="price-text">${p.price}</span></td>
      <td style="text-align: center;"><span style="color: ${marginColor}; font-weight: 800; font-size: 11px; background: rgba(255,255,255,0.06); padding: 2px 6px; border-radius: 4px;">${marginText}</span></td>
